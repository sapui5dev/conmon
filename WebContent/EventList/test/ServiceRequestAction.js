(function () {
  ...
  jQuery.sap.declare("insurance.threeaccounts.test.ServiceRequestAction");
  jQuery.sap.require("sap.ui.test.Opa5");
  jQuery.sap.require("sap.ui.test.opaQunit");

  insurance.threeaccounts.test.ServiceRequestAction = sap.ui.test.Opa5.extend("insurance.threeaccounts.test.ServiceRequestAction", {
