(function() {
  ...
  jQuery.sap.declare("insurance.threeaccounts.test.ServiceRequestAssertion");
  jQuery.sap.require("sap.ui.test.Opa5");
  jQuery.sap.require("sap.ui.test.opaQunit");

  insurance.threeaccounts.test.ServiceRequestAssertion = sap.ui.test.Opa5.extend("insurance.threeaccounts.test.ServiceRequestAssertion", {
